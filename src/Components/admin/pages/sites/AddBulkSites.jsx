...
export default function AddBulkSites({
  templateLoading = false,
  templateDownload,
  uploadUserTemplateLoading = false,
  templateUploadFunction,
  bulkUserTaskListLoading = false,
  ...
  return (
    <div className='space-y-2 '>
      <h3 className='text-black pb-2 text-sm font-medium font-Poppins leading-normal tracking-tight'>
        Download file format to add Site Meta Data
      </h3>
      <button
