        ...
        <span className=" flex flex-col w-[100%] ">
          ...
          <div className="   px-[60px]  border-b">
            <div className=" flex w-[35%]  justify-around ">
              <span className=" border-b-2 border-[#1F5095] pt-8 pb-3 pl-3 pr-3  text-[#1F5095] text-[14px] font-Poppins font-semibold">
                Catalogue
              </span>
              <span className="pt-8 pb-3 pl-3 pr-3  text-[#454545] text-[14px] font-Poppins font-semibold opacity-[40%]">
                Sites / Databases
              </span>
              <span className=" pt-8 pb-3 pl-3 pr-3  text-[#454545] text-[14px] font-Poppins font-semibold opacity-[40%]">
                Library / OPAC
                ...
                "
                  ...
                  <div className=" flex flex-row">
                    <div className=" mr-3  rounded-full border w-[35px] h-[35px] flex justify-center items-center">
                      <img src={bookmarkicon2} className=" w-[10px] h-[12px]" />{" "}
                    </div>
                    <div className=" mr-3  rounded-full border w-[35px] h-[35px] flex justify-center items-center">
